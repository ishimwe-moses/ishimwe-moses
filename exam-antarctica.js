const questions = [
    ...
    { question: "Which country's flag is shown below?<br><img src='flag-of-usa.jpeg' alt='Flag of USA'>", type: "multiple", options: ["USA", "Russia", "Australia"], answer: "USA" },
    { question: "Which animal is shown below?<br><img src='emperor-penguin.jpeg' alt='Emperor Penguin'>", type: "multiple", options: ["Penguin", "Seal", "Polar Bear"], answer: "Penguin" },
    { question: "Which landmark is shown below?<br><img src='ross-ice-shelf.jpeg' alt='Ross Ice Shelf'>", type: "multiple", options: ["Ross Ice Shelf", "Mount Erebus", "South Pole"], answer: "Ross Ice Shelf" },
    { question: "Which activity is shown in the image below?<br><img src='ice-core-drilling.jpeg' alt='Ice Core Drilling'>", type: "multiple", options: ["Ice Core Drilling", "Volcanic Eruption", "Astronomy"], answer: "Ice Core Drilling" },
    { question: "Which animal is shown below?<br><img src='weddell-seal.jpeg' alt='Weddell Seal'>", type: "multiple", options: ["Weddell Seal", "Penguin", "Polar Bear"], answer: "Weddell Seal" },
    { question: "Which phenomenon is shown below?<br><img src='aurora.jpeg' alt='Aurora'>", type: "multiple", options: ["Aurora", "Glacier Calving", "Iceberg"], answer: "Aurora" },
    { question: "Which activity is shown below?<br><img src='astronomy-in-antarctica.jpeg' alt='Astronomy in Antarctica'>", type: "multiple", options: ["Astronomy", "Glaciology", "Seismic Activity"], answer: "Astronomy" },
    { question: "Which research station is shown below?<br><img src='mcmurdo-station.jpeg' alt='McMurdo Station'>", type: "multiple", options: ["McMurdo Station", "Amundsen-Scott Station", "Concordia Station"], answer: "McMurdo Station" },
    { question: "Which ocean is shown below?<br><img src='southern-ocean.jpeg' alt='Southern Ocean'>", type: "multiple", options: ["Southern Ocean", "Atlantic Ocean", "Pacific Ocean"], answer: "Southern Ocean" },
    { question: "Which landmark is shown below?<br><img src='mount-erebus.jpeg' alt='Mount Erebus'>", type: "multiple", options: ["Mount Erebus", "Mount Everest", "Ross Ice Shelf"], answer: "Mount Erebus" },
    { question: "Which activity is shown below?<br><img src='glacier-calving.jpeg' alt='Glacier Calving'>", type: "multiple", options: ["Glacier Calving", "Volcanic Eruption", "Iceberg Formation"], answer: "Glacier Calving" },
    { question: "Which continent is shown below?<br><img src='antarctica-map.jpeg' alt='Map of Antarctica'>", type: "multiple", options: ["Antarctica", "Australia", "South America"], answer: "Antarctica" },
    { question: "Which type of ice formation is shown below?<br><img src='iceberg.jpeg' alt='Iceberg'>", type: "multiple", options: ["Iceberg", "Glacier", "Ice Sheet"], answer: "Iceberg" },
    { question: "Which research activity is shown below?<br><img src='antarctic-research.jpeg' alt='Antarctic Research'>", type: "multiple", options: ["Glaciology", "Astronomy", "Marine Biology"], answer: "Glaciology" },
    { question: "Which phenomenon is shown below?<br><img src='cosmic-microwave.jpeg' alt='Cosmic Microwave Radiation'>", type: "multiple", options: ["Cosmic Microwave Radiation", "Aurora", "Glacier Calving"], answer: "Cosmic Microwave Radiation" },
    { question: "Which research base is shown below?<br><img src='amundsen-scott-station.jpeg' alt='Amundsen-Scott Station'>", type: "multiple", options: ["Amundsen-Scott Station", "McMurdo Station", "Concordia Station"], answer: "Amundsen-Scott Station" },
    { question: "Which ice shelf is shown below?<br><img src='larsen-ice-shelf.jpeg' alt='Larsen Ice Shelf'>", type: "multiple", options: ["Larsen Ice Shelf", "Ross Ice Shelf", "Filchner-Ronne Ice Shelf"], answer: "Larsen Ice Shelf" },
    { question: "Which type of research is shown below?<br><img src='antarctic-glaciology.jpeg' alt='Antarctic Glaciology'>", type: "multiple", options: ["Glaciology", "Astronomy", "Marine Biology"], answer: "Glaciology" },
    { question: "Which type of seal is shown below?<br><img src='crabeater-seal.jpeg' alt='Crabeater Seal'>", type: "multiple", options: ["Crabeater Seal", "Weddell Seal", "Leopard Seal"], answer: "Crabeater Seal" },
    { question: "Which region is shown below?<br><img src='east-antarctica.jpeg' alt='East Antarctica'>", type: "multiple", options: ["East Antarctica", "West Antarctica", "Antarctic Peninsula"], answer: "East Antarctica" },
];
